...
create table countries (country_id char(2) primary key,country_name varchar(50),region_id int,foreign key (region_id) references regions(region_id));
create table locations (location_id int primary key,street_address varchar(100),postal_code varchar(20),city varchar(50),state_province varchar(50),country_id char(2),foreign key (country_id) references countries(country_id));
create table jobs (job_id int primary key,job_title varchar(50),min_salary int,max_salary int);
create table departments(department_id int primary key,department_name varchar(50),location_id int,foreign key (location_id) references locations(location_id));
create table employees (employee_id int primary key,first_name varchar(50),last_name varchar(50),email varchar(100),phone_number varchar(20),hire_date date,job_id int,salary int,manager_id int,department_id int,foreign key (job_id) references jobs(job_id),foreign key(department_id) references departments(department_id));
...
Haan','lex.de haan@sqltutorial.org','515.123.4569','1993-01-13',5,17000,100,9);
INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
...
Manuel','Urman','jose manuel.urman@sqltutorial.org','515.124.4469','1998-03-07',6,7800,108,10);
INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
...
select first_name,last_name from employees where job_id="SH_CLERK";
...
SELECT first_name, last_name FROM employees WHERE hire_date >= '1995-01-01' AND hire_date < '1998-01-01' LIMIT 0, 2000;
